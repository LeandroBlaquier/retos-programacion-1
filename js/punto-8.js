...
// let consumo = Number(prompt("Indica el consumo total"));
// let numPersonas = Number(prompt("Indica el numero de personas"));
// let impuestos = Number(prompt("Indica el porcentaje de impuestos"));
// let propina = Number(prompt("Indica el porcentaje de propina"));
// let consumoTotal =
//   consumo + consumo * (impuestos / 100) + consumo * (propina / 100);
// let totalPorPersona = consumoTotal / numPersonas;

// alert(
//   `El total fue de $${consumoTotal} y a cada persona le tocan $${totalPorPersona}`
// );
